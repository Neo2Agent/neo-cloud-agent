import { isDeepseekFlashModel, resolveModelLimits, resolveRequestMaxTokens } from "@neo-cloud-agent/contracts";
...
export function supportsVision(modelId: string): boolean {
  ...
  return isDeepseekFlashModel(id) || /^gpt-4o|^gpt-4\.1|^chatgpt-4o|^o[1-9]/i.test(id);
}
