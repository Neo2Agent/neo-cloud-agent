...
目的：弄清它的「项目协作」到底卖什么，再对照 Neo Cloud Agent 现在能做什么，给出一份能跟着做、又不照抄办公套件的落地顺序。专家 / 专家团单独见 [workbuddy-experts.md](./workbuddy-experts.md)。
...
- 专家**市场**、技能市场（专家角色包见 [workbuddy-experts.md](./workbuddy-experts.md)）
